# User info enumeration (e.g., accountID, password, personnel information such as name,  DOB, etc)
...
> If the tester enters a nonexistent user ID, they can receive a message as such - "This User is Not Active*"
>
...
https://github.com/OWASP/wstg/blob/master/document/4-Web_Application_Security_Testing/03-Identity_Management_Testing/04-Testing_for_Account_Enumeration_and_Guessable_User_Account.md
