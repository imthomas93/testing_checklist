# Session tokens for cookie flags (httpOnly and secure)
...
Below, a description of every attribute will be discussed. The tester should validate that they are being used properly by the application. Cookies can be reviewed by using an [intercepting proxy](#intercepting-proxy), or by reviewing the browser's cookie jar.
